...
// Payloads project
// Program to solve the motion of a rocket under a non-uniform gravitational field with varying step sizes for RK algorithms
...
int main()
{
	ofstream fout ("Project3_output.dat");

	//y1 is the start point, y2 is the initial momentum
	double h, y1 = 1, y2 = 0;
	
	cout << "What step size do you want the Runge-Kutta algorithm to use?\nIt must be less than 1 and greater than 0.\n";
	cin >> h;
	while (h <= 0 || h >=1)
	{
		cout << "Please enter a number less than 1 and greater than 0, eg, 0.001.\n";
		cin >> h;
	}	
	...
	cout << "t\t2nd order Runge-Kutta\t4th order Runge-Kutta\n";
